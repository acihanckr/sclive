...
def test_prop_plt(scanpy_std_pipeline):
    ...
    prop_plt(adata, "leiden", "fake_cats", plt_type="pct", meta_order=["0", "1", "2", "3", "4", "5", "6"]).write_html("fig.html")
    prop_plt(adata, "leiden", "fake_cats", plt_type="pct", meta_order=["0", "1", "2", "3", "4", "5", "6"], group_order=["C","A", "B"]).write_html("fig.html")
