...
def test_violin_plt(scanpy_std_pipeline):
    ...
    violin_plt(adata, "leiden", "n_genes", "fake_dogs", vln_type="split").write_html("fig.html")
    violin_plt(adata, "leiden", "n_genes", "fake_cats", vln_type="split").write_html("fig.html")
    ...
    violin_plt(adata, "leiden", "CST3", axis_font_size=None).write_html("fig.html")
    violin_plt(adata, "leiden", "CST3", ticks_font_size=20).write_html("fig.html")
    violin_plt(adata, "leiden", "n_genes", pts="all", pt_size=12).write_html("fig.html")
    violin_plt(adata, "leiden", "n_genes", legend_size=20).write_html("fig.html")
    violin_plt(adata, "leiden", "n_genes", "fake_cats", vln_type="grouped", pts="all", legend_size=20).write_html("fig.html")
    ...
    violin_plt(adata, "leiden", "CST3", axis_font_size=12, title_size=12, title="Violin Plot").write_html("fig.html")
