...
def test_dimred_plt_2d(scanpy_std_pipeline):
    ...
    dimred_plt_2d(adata, "X_umap", "leiden", width=800,height=800, pt_size=5, legend_font_size=12).write_html("fig.html")
    dimred_plt_2d(adata, "X_umap", "leiden", width=800,height=800, pt_size=5, legend_font_size=12, labels_size=12).write_html("fig.html")
    dimred_plt_2d(adata, "X_umap", "CST3", width=800,height=800, pt_size=5,   legend_font_size=40, labels_size=40, is_gene_exp = True).write_html("fig.html")
    dimred_plt_2d(adata, "X_umap", "CST3", width=800,height=800, pt_size=5,   legend_font_size=40, labels_size=40, is_gene_exp = True, legend_title="CST3").write_html("fig.html")
    dimred_plt_2d(adata, "X_umap", "leiden", width=800,height=800, pt_size=5, legend_font_size=40, labels_size=40, title_size=12).write_html("fig.html")
    dimred_plt_2d(adata, "X_umap", "leiden", width=800,height=800, pt_size=5, legend_font_size=12, legend_title = "Leiden Clusters", labels_size=12, title_size=12, title="Test").write_html("fig.html")
    dimred_plt_2d(adata, "X_umap", "leiden", width=800,height=800, pt_size=5, legend_font_size=40, legend_title = "Leiden Clusters", labels_size=12, title_size=12, title="Test", axis_font_size=12).write_html("fig.html")
    dimred_plt_2d(adata, "X_umap", "leiden", width=800,height=800, pt_size=5, legend_font_size=12, labels_size=12, title_size=12, title="Test", axis_font_size=12, dimred_labels="PCA").write_html("fig.html")
    dimred_plt_2d(adata, "X_umap", "leiden", width=800,height=800, pt_size=5, legend_font_size=12, labels_size=12, title_size=12, title="Test", axis_font_size=12, dimred_labels=["PC1", "PC2"], ticks_font_size=40).write_html("fig.html")
