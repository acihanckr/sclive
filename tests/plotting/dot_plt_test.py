...
def test_dot_plt(scanpy_std_pipeline):
    ...
    dot_plt(adata, "leiden", ["CST3", "SLC39A3"], legend_font_size = 20).write_html("fig.html")
    dot_plt(adata, "leiden", sample(adata.var_names.to_list(), k=10), legend_font_size = 20).write_html("fig.html")
    ...
    dot_plt(adata, "leiden", ["CST3", "SLC39A3"], legend_font_size = 40).write_html("fig.html")
    dot_plt(adata, "leiden", ["CST3", "SLC39A3"], legend_font_size = 40, legend_title="Legend").write_html("fig.html")
