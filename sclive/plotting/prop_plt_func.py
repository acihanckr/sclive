...
def prop_plt(adata, 
            ...
            axis_font_size:Optional[int]=12, 
    ...
    :param x: x axis variable to draw
    :param y: y axis variable to draw
    :param stacked: either to stack or split the bars across y meta
    :param plt_type: either to plot proportions or counts. Options: 'count', 'pct'
    :param coord_flip: either to flip the coordinates
    ...
    :param axis_font_size: font size of the axis labels. If None, axis labels will be omitted 
    ...
    fig = set_2d_layout(fig, ticks_font_size, dimred_labels = [x,y],
